...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="assets/images/adminicon.png" />
  </head>
  <body>
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.blade.php"><img src="assets/images/logo.svg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="index.blade.php"><img src="assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="assets/images/faces/faceAnnesha.jpg" alt="">
                  <span class="count bg-success"></span>
                </div>
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Annesha Ahsan</h5>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="assets/images/faces/faceAnnesha.jpg" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">Annesha Ahsan</p>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <img src="assets/images/faces/faceAnnesha.jpg" alt="image" />
                              <span class="pl-2">Annesha Ahsan</span>
                            </td>
                            <td> 02312 </td>
                            <td> $14,500 </td>
                            <td> Dashboard </td>
